...
export default function CaseStudies() {
  return (
    <section id="cases" className="bg-vow-dark py-24 lg:py-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {caseStudies.map((study, i) => (
            <motion.div
              ...
              className="bg-vow-surface border border-vow-border rounded-xl p-7 flex flex-col hover:border-vow-primary/40 transition-colors"
            >
              {/* Tag + route */}
